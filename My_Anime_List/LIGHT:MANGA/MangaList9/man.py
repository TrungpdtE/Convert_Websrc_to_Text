...
# # Xuất danh sách vào các tệp
# with open('type.txt', 'w', encoding='utf-8') as type_file, \
#      open('volume.txt', 'w', encoding='utf-8') as volume_file:

#     for manga_type, volume in zip(type_list, volume_list):
#         type_file.write(f"{manga_type}\n")
#         volume_file.write(f"{volume}\n")

# print("Danh sách đã được xuất vào type.txt và volume.txt")
